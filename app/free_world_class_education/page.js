...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Free, World Class Education">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                <li>
                                                    <Link href="/free_world_class_education" className="current" >
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/education1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Free, World Class Education</h2>
                                                <p>Khan Academy offers all its content for free, making high-quality science education accessible to anyone with an internet connection.
                                                </p>
