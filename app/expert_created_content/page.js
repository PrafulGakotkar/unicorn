                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/expert_created_content" className="current">Expert-Created Content</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Expert-Created Content1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Expert-Created Content</h2>
                                                <p>Khan Academy partners with subject-matter experts and institutions to ensure the accuracy and quality of its science content.
                                                </p>
