                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/ask_an_expert_forum" className="current">Ask an Expert Forum</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/asl an forum1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Ask an Expert Forum</h2>
                                                <p>
                                                Students can connect with scientists and engineers through a moderated online forum. This allows students to ask questions, get feedback on their projects, and gain insights from real-world experts.
                                                </p>
