...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Jasper">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/jasper" className="current">Jasper</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/jasper1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Jasper</h2>
                                                <h4>Uses</h4>
                                                ...
                                                <h4>Features</h4>
                                                <p>AI-generated content, templates, tone adjustment</p>
                                                <h4>Description</h4>
                                                <p>An AI writing assistant focused on generating marketing copy, blog posts, and other content.
                                                </p>
                                            </div>
                                            <div className="more-btn mt_60">
                                                <Link href="https://www.jasper.ai/" className="theme-btn-one">Read More</Link>
                                            </div>
                                        </div>
