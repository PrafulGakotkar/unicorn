...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Practice Exercises and Quizzes">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                <li>
                                                    <Link href="/free_world_class_education" >
                                                        Free, World Class Education
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/personalize_learning" >Personalized Learning</Link>
                                                </li>
                                                <li>
                                                    <Link href="/microlearning">Microlearning</Link>
                                                </li>
                                                <li>
                                                    <Link href="/mastery_based_learning" >Mastery-Based Learning</Link>
                                                </li>
                                                <li>
                                                    <Link href="/practice_exercises_and_quizzes" className="current">Practice Exercises and Quizzes</Link>
                                                </li>
                                                <li>
                                                    <Link href="/process_tracking">Progress Tracking</Link>
                                                </li>
                                                <li>
                                                    <Link href="/science_cources">Science Courses</Link>
                                                </li>
                                                <li>
                                                    <Link href="/expert_created_content" >Expert-Created Content</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Practice Exercises and Quizzes1 .jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Practice Exercises and Quizzes</h2>
                                                <p>Khan Academy offers a vast library of practice exercises and quizzes that reinforce learning from the video lessons. Students receive immediate feedback on their performance.
                                                </p>
