                    ...
                    <section className="service-style-two p_relative">
                        <div className="auto-container">
                            <div className="sec-title centred mb_50">
                                ...
                                <p>Khan Academy:(https://www.khanacademy.org/humanities/world-history) Offers free video lectures, practice exercises, and quizzes that cover a wide range of social studies topics.		
                                </p>
                            </div>
                            <div className="row clearfix">
                                    ...
                                    <div className="service-block-two wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <figure className="image-box">
                                                <img src="assets/images/service/subject.jpg" alt="" />
                                            </figure>
                                            <div className="lower-content">
                                                <div className="inner">
                                                    <div className="icon-box"><i className="icon-7"></i></div>
                                                    <h3><Link href="https://www.khanacademy.org/humanities/world-history">Subject</Link></h3>
                                                    <p>World History<br/><br/><br/>
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.khanacademy.org/humanities/world-history" className="theme-btn-one">Read More</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-two wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <figure className="image-box">
                                                <img src="assets/images/service/content.jpg" alt="" />
                                            </figure>
                                            <div className="lower-content">
                                                <div className="inner">
                                                    <div className="icon-box"><i className="icon-12"></i></div>
                                                    <h3><Link href="https://www.khanacademy.org/humanities/world-history">Content</Link></h3>
                                                    <p>Free video lectures, practice exercises, and quizzes<br/><br/>
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.khanacademy.org/humanities/world-history" className="theme-btn-one">Read More</Link>
                                                    </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Topics Covered.jpg" alt="" />
                                            </figure>
                                            <div className="lower-content">
                                                <div className="inner">
                                                    <div className="icon-box"><i className="icon-8"></i></div>
                                                    <h3><Link href="https://www.khanacademy.org/humanities/world-history">Topics Covered</Link></h3>
                                                    <p>Different time periods and important civilizations, social institutions, art, and trade</p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.khanacademy.org/humanities/world-history" className="theme-btn-one">Read More</Link>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    <div className="icon-box"><i className="icon-8"></i></div>
                                                    <h3><Link href="https://www.khanacademy.org/humanities/world-history">Examples</Link></h3>
                                                    <p>The Neolithic Revolution, the rise of empires, and the development of new trading cities</p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.khanacademy.org/humanities/world-history" className="theme-btn-one">Read More</Link>
                                                    </div>
                                                </div>
