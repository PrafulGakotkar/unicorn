...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Microlearning">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/microlearning" className="current">Microlearning</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/microlearning1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Micro Learning</h2>
                                                <p>Content is broken down into short, manageable videos and exercises, allowing students to learn at their own pace and in bite-sized chunks.
                                                </p>
