...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Video and Audio Content">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/video_and_audio_content" className="current">Video and Audio Content</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/videoAudio1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Video and Audio Content</h2>
                                                <p>BBC Science incorporates multimedia elements like videos and podcasts to enhance the user experience. Videos can showcase scientific phenomena or experiments, while podcasts offer interviews with scientists and experts.
                                                </p>
