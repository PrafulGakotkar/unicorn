                    ...
                    <section className="service-style-two p_relative">
                        <div className="auto-container">
                            <div className="sec-title centred mb_50">
                                ...
                                <p><b>Library of Congress:</b>(https://www.loc.gov/)  Provides access to historical documents, photographs, and other primary sources.		
                                </p>
                            </div>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    ...
                                                    <h3><Link href="https://www.loc.gov/">Collections
</Link></h3>
                                                    <p>Books, manuscripts, maps, films, and more
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.loc.gov/" className="theme-btn-one">Read More</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    ...
                                                    <h3><Link href="https://www.loc.gov/">Educational resources
                                                    </Link></h3>
                                                    <p>Programs and exhibitions<br/><br/>
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.loc.gov/" className="theme-btn-one">Read More</Link>
                                                    </div>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    ...
                                                    <h3><Link href="https://www.loc.gov/">Online resources
                                                    </Link></h3>
                                                    <p>Extensive collection of digital materials
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://www.loc.gov/" className="theme-btn-one">Read More</Link>
                                                    </div>
