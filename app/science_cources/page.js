                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/science_cources" className="current">Science Courses</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/science cources1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Science Courses</h2>
                                                <p>Khan Academy offers a wide range of science courses, from elementary science basics to high school-level biology, chemistry, physics, and more.
                                                </p>
