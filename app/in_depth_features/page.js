...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="In Depth Features">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/in_depth_features" className="current">In-Depth Features</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/inDepthFeature1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>In Depth Features</h2>
                                                <p>Beyond breaking news, BBC Science dives deeper into specific scientific issues with in-depth features. These features provide more context and analysis, allowing readers to gain a greater understanding of complex topics.
                                                </p>
