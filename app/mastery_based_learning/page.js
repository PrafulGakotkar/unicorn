...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Mastery-Based Learning">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/mastery_based_learning" className="current">Mastery-Based Learning</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/mastery based learning1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Mastery-Based Learning</h2>
                                                <p>Khan Academy focuses on mastery learning. Students progress through lessons only after demonstrating understanding of the concepts. This ensures a strong foundation before moving on.
                                                </p>
