...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Teacher Resources">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/teacher_resources" className="current">Teacher Resources</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Teacher Resources1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Teacher Resources</h2>
                                                <p>
                                                A dedicated section provides lesson plans, project ideas, and classroom management tips specifically for teachers who are guiding students through science fair projects.
                                                </p>
