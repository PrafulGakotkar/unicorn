...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Variety of Media">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/variety_of_media" className="current">Variety of Media</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Variety of Media1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Variety of Media</h2>
                                                <p>
                                                National Geographic Science offers a range of media formats to cater to different learning styles. Readers can choose from informative articles, visually stunning videos, and interactive games, making science exploration engaging and fun.</p>
