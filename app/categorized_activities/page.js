...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Categorized Activities">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/categorized_activities" className="current">Categorized Activities</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Categorized Activities1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Categorized Activities</h2>
                                                <p>
                                                The website categorizes experiments by age group, scientific concept, and even themes like "gross science" or "outdoor science." This allows parents and educators to find activities that are appropriate and engaging for different ages and interests.
                                                </p>
