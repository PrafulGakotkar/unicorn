                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/grammarly" className="current">Grammarly</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Grammarly1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Grammarly</h2>
                                                <h4>Uses</h4>
                                                <p>  Writing enhancement, grammar checking
                                                </p>
                                                <h4>Features</h4>
                                                <p>Grammar check, plagiarism detection, style suggestions
                                                </p>
                                                <h4>Description</h4>
                                                <p>A writing assistant that helps improve grammar, spelling, punctuation, and overall writing style.
                                                </p>
                                            </div>
