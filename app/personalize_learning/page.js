...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Personalized Learning">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/personalize_learning" className="current">Personalized Learning</Link>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <Link href="/practice_exercises_and_quizzes">Practice Exercises and Quizzes</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/personalized learning1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Personalized Learning</h2>
                                                <p>Khan Academy uses adaptive learning technology to personalize the learning experience. Students practice exercises, and the platform identifies strengths and weaknesses, recommending lessons that target specific needs.
                                                </p>
