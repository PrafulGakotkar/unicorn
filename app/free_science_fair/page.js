...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Free Science Fair Project Ideas">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                <li>
                                                    <Link href="/free_science_fair" className="current">
                                                        Free Science Fair Project Ideas
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/project_guides">Project Guides</Link>
                                                </li>
                                                <li>
                                                    <Link href="/video_and_audio_content">Ask an Expert Forum</Link>
                                                </li>
                                                <li>
                                                    <Link href="/science_fair_tools">Science Fair Tools</Link>
                                                </li>
                                                <li>
                                                    <Link href="/engineering_design_challenges">Engineering Design Challenges</Link>
                                                </li>
                                                <li>
                                                    <Link href="/teacher_resources">Teacher Resources</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Free Science Fair Project Ideas1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Free Science Fair Project Ideas</h2>
                                                <p>
                                                Science Buddies offers a vast collection of science fair project ideas searchable by topic, grade level, and difficulty. Each idea includes a brief description and links to further resources.
                                                </p>

                                            </div>
                                            <div className="more-btn mt_60">
                                                <Link href="https://www.sciencebuddies.org/" className="theme-btn-one">Read More</Link>
                                            </div>
                                        </div>
