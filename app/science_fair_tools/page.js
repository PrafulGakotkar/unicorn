...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Science Fair Tools">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/ask_an_expert_forum" >Ask an Expert Forum</Link>
                                                </li>
                                                <li>
                                                    <Link href="/science_fair_tools" className="current">Science Fair Tools</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Science Fair Tools1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Science Fair Tools</h2>
                                                <p>
                                                Science Buddies provides downloadable tools like grading rubrics, lab safety checklists, and data analysis templates to help students stay organized and complete their projects effectively.
                                                </p>
