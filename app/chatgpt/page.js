...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="ChatGPT">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                <li>
                                                    <Link href="/chatgpt" className="current">
                                                        ChatGPT</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/chatgpt1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>ChatGPT</h2>
                                                <h4>Uses</h4>
                                                <p>  Conversational AI, content generation</p>
                                                <h4>Features</h4>
                                                <p>Natural language understanding, context retention</p>
                                                <h4>Description</h4>
                                                <p>An AI chatbot developed by OpenAI, capable of engaging in detailed conversations and generating text.</p>
                                            </div>
                                            <div className="more-btn mt_60">
                                                <Link href="https://www.openai.com/chatgpt" className="theme-btn-one">Read More</Link>
                                            </div>
                                        </div>
