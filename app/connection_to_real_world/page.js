...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Connection to Real-World Science">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/connection_to_real_world" className="current">Connection to Real-World Science</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Connection to Real-World Science1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Connection to Real-World Science</h2>
                                                <p>
                                                    National Geographic Science connects scientific concepts to real-world applications and current events. This approach helps users understand the relevance of science in their everyday lives.
                                                </p>
