...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Simple and Safe Instructions">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/simple_and_safe_instructions" className="current">Simple and Safe Instructions</Link>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <Link href="/categorized_activities
                                                    ">Categorized Activities</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            ...
                                            <div className="text">
                                                ...
                                                <p>
                                                Each experiment comes with clear, step-by-step instructions that are easy for children to understand, often accompanied by pictures or videos. Safety precautions are emphasized to ensure safe experimentation.                                                </p>
