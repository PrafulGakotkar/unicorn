...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Voice Repurpose">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/voice_repurpose"className="current">Voice Repurpose</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Voice Repurpose1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Voice Repurpose</h2>
                                                <h4>Uses</h4>
                                                <p>Audio content creation, podcasting
                                                </p>
                                                <h4>Features</h4>
                                                <p>Audio editing, voice synthesis, content repurposing
                                                </p>
                                                <h4>Description</h4>
                                                <p>A tool for creating and repurposing audio content, including podcasts and voice-overs.
                                                </p>
                                            </div>
                                            <div className="more-btn mt_60">
                                                <Link href="https://www.voicerepurpose.com/" className="theme-btn-one">Read More</Link>
                                            </div>
                                        </div>
