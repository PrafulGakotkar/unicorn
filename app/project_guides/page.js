...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Project Guides">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/project_guides" className="current">Project Guides</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Project Guides1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Project Guides</h2>
                                                <p>
                                                    In-depth guides walk students through the entire science fair project process, from choosing a topic and forming a hypothesis to conducting experiments, analyzing data, and creating a presentation board.
                                                </p>
