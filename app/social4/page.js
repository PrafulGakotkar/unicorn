                    ...
                    <section className="service-style-two p_relative">
                        <div className="auto-container">
                            <div className="sec-title centred mb_50">
                                ...
                                <p><b>Newsela:</b> (https://newsela.com/) Curates current events articles and modifies them for different reading levels, making complex topics accessible.		
                                </p>
                            </div>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    ...
                                                    <h3><Link href="https://newsela.com/">Purpose                                                    </Link></h3>
                                                    <p>Provides access to leveled nonfiction texts and assessments
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://newsela.com/" className="theme-btn-one">Read More</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    ...
                                                    <h3><Link href="https://newsela.com/">Target Audience
                                                    </Link></h3>
                                                    <p>Educators and Students <br/><br/>
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://newsela.com/" className="theme-btn-one">Read More</Link>
                                                    </div>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    ...
                                                    <h3><Link href="https://newsela.com/">Content
                                                    </Link></h3>
                                                    <p>Nonfiction texts in various subjects including ELA, social studies, and science
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://newsela.com/" className="theme-btn-one">Read More</Link>
                                                    </div>
                                    ...
                                    <div className="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            ...
                                            <div className="lower-content">
                                                <div className="inner">
                                                    <div className="icon-box"><i className="icon-8"></i></div>
                                                    <h3><Link href="https://newsela.com/">Additional Features
                                                    </Link></h3>
                                                    <p>Skill-building activities, quizzes, and real-time data
                                                    </p>
                                                    <div className="btn-box">
                                                        <Link href="https://newsela.com/" className="theme-btn-one">Read More</Link>
                                                    </div>
