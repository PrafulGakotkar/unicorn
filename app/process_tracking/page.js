...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Progress Tracking">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/process_tracking" className="current">Progress Tracking</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Progress Tracking1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Progress Tracking</h2>
                                                <p>A personalized dashboard tracks student progress, allowing them to see how far they've come and what areas still need work.
                                                </p>
