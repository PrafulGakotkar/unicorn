...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="News Articles">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                <li>
                                                    <Link href="/news_articles" className="current">
                                                        News Articles
                                                    </Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            ...
                                            <div className="text">
                                                <h2>News Articles</h2>
                                                <p>
                                                    BBC Science offers up-to-date news articles on a wide range of scientific topics, from astronomy and space exploration to biology, medicine, and the environment. Articles are written in a clear and concise style, making them accessible to a general audience.</p>
