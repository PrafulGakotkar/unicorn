...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Interactive Learning">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/interactive_learning" className="current">Interactive Learning</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Interactive Learning1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Interactive Learning</h2>
                                                <p>
                                                The website incorporates interactive elements like games and quizzes. These activities allow users to test their knowledge, reinforce learning, and engage with scientific concepts in a more immersive way.
