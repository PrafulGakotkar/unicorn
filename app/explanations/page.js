...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Explanations">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/explanations" className="current">Explanations</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Explanations1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Explanations</h2>
                                                <p>
                                                    Crazy Scientist goes beyond just providing instructions. They explain the science behind each experiment, helping children understand the concepts at work and fostering curiosity.
                                                </p>
