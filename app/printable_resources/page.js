...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Printable Resources">
                <div>
                                    ...
                                    <div className="service-sidebar mr_40">
                                        <div className="sidebar-widget category-widget">
                                            ...
                                            <ul className="category-list clearfix">
                                                ...
                                                <li>
                                                    <Link href="/printable_resources" className="current">Printable Resources</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="service-details-content">
                                        <div className="content-one mb_90">
                                            <figure className="image-box">
                                                <img src="assets/images/service/Printable Resources1.jpg" alt="" />
                                            </figure>
                                            <div className="text">
                                                <h2>Printable Resources</h2>
                                                <p>
                                                    The website offers downloadable resources like experiment checklists and lab notebook templates, making it easy for kids to organize their scientific explorations.
                                                </p>
